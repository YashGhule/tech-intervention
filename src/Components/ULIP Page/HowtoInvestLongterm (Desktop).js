...
export default function List24Panel24() {
        ...
        <List component="nav" className={classes.root} aria-label="mailbox folders">
            <ListItem >
                <Typography className={classes.body}>
                    Short-term financial challenges can wreak havoc on your long-term financial plans. If things get difficult, we prefer to turn to investments that can be quickly liquidated.And that is when <b>investment lock-in periods,</b> such as those found in <b>unit linked insurance plans</b> online in India (ULIPs), come in handy.
                </Typography>
            </ListItem>
            {/* <Divider /> */}
