...
export default function List6Panel6() {
  ...
  return (
    <List component="nav" className={classes.root} aria-label="mailbox folders">
      <ListItem >
        <b>Following are the steps to be followed for choosing the ULIP plan:</b>
      </ListItem>
      {/* <Divider /> */}
      <ListItem style={{ color: "#00529C" }}>
        <b>1. Claim Settlement Ratio</b>
      </ListItem >
      <ListItem >
      ...
      <ListItem style={{ color: "#00529C" }}>
        <b>2. Performance of ULIP Funds</b>
      </ListItem >
      <ListItem >
      ...
      <ListItem style={{ color: "#00529C" }}>
        <b>4. Investment Strategies Offered</b>
      </ListItem >
      <ListItem >
